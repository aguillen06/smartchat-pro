 ...
 * WARNING: Only import this in API routes or server components
 * This file uses SUPABASE_SERVICE_ROLE_KEY which should never be exposed to the browser
 */
...
/**
 * Regular Supabase client for server-side operations with RLS
